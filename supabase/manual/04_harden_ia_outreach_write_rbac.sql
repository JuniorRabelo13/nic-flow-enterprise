-- IA OUTREACH WRITE RBAC HARDENING
-- Aplicar somente após as tabelas IA Outreach e as funções public.is_workspace_member/public.workspace_member_role existirem.
-- SELECT permanece permitido para membros ativos; escrita passa a exigir owner/admin.
